...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        ParseSwift.initialize(applicationId: "zf7btga3rWiS8CmFUWcoyBrvw25PLe0l55ktUMqP",
                              clientKey: "wtCu5bULaQoOnNVuEdLBjpDyQ3uESpZdob61jfUi",
        ...
        // Tested saving the test parse object to my server and it was a success.
